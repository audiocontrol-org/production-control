...
### Tests (RED first)
- [ ] T008 [P] [US1] [tier:balanced] RED integration test: a faithful fixture edition + ledger + source → `verdict: passed` and a coverage report enumerating each check's state and counts (quickstart S1) in `voice-tooling/test/fidelity-pass.test.mjs`.
