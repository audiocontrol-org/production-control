 ...
 * them: impure (AI-generated, non-reproducible) output roots under the dot-zoned `.ai/`
 * (AI-permitted per `classifyZone`), pure (reproducible) output stays under `dist/`.
 */

/** The output root for impure (AI-generated, non-reproducible) build output. Dot-zoned so
